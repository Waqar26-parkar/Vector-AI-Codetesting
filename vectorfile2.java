...
public class vectorfile2 {
    ...
    public void startReport() {
        htmlReporter = new ExtentSparkReporter("C:\\Users\\waqar.farooqui\\Downloads\\First\\src\\test\\java\\Extent-reports\\Testcase4.html");
...
driver.get("https://www.saucedemo.com/");
    ...
    public void verifyHelpCenterContent() {
        test = reports.createTest("Help Center content verification: Navigate to any page on the website", 
        ...
        try {
            ...
            test.log(Status.FAIL, "Failed to access the specified page on the website: " + e.getMessage());
        }
    }
    ...
    public void locateHelpCenterLink() {
        test = reports.createTest("Locate Help Center link: Locate the Help Center link in the footer or header of the page", 
        ...
        try {
            ...
            test.log(Status.PASS, "User was able to find and access the Help Center link.");
        } catch (Exception e) {
    ...
    public void accessHelpCenterPage() {
        test = reports.createTest("Access Help Center page: Click on the Help Center link to access the Help Center", 
        ...
        try {
            ...
            test.log(Status.FAIL, "User was directed to the Help Center page successfully.");
        } catch (Exception e) {
            test.log(Status.FAIL, "Failed to access the Help Center page: " + e.getMessage());
        }
    }
...
public void placeOrderAndReceiveConfirmationEmail() {
    ...
    try {
        ...
        boolean isEmailReceived = checkEmailReceived1("ORDER_CONFIRMATION_SUBJECT"); // Replace 'ORDER_CONFIRMATION_SUBJECT' with the actual subject of the confirmation email
...
public void waitForOrderToBeProcessedAndShipped() {
    ...
    try {
        ...
        boolean isShippingEmailReceived = checkEmailReceived1("SHIPPING_CONFIRMATION_SUBJECT"); // Replace 'SHIPPING_CONFIRMATION_SUBJECT' with the actual subject of the shipping confirmation email
...
public void waitForOrderToBeOutForDelivery() {
    ...
    try {
        ...
        boolean isDeliveryEmailReceived = checkEmailReceived1("DELIVERY_CONFIRMATION_SUBJECT"); // Replace 'DELIVERY_CONFIRMATION_SUBJECT' with the actual subject of the delivery confirmation email
...
public void receiveConfirmationEmailForReturns() {
    test = reports.createTest("Receive Confirmation Email for Returns: Log in to the customer account", 
    ...
    try {
        ...
        boolean isReturnConfirmationEmailReceived = checkEmailReceived1("RETURN_CONFIRMATION_SUBJECT"); // Replace 'RETURN_CONFIRMATION_SUBJECT' with the actual subject of the return confirmation email
        ...
        test.log(Status.FAIL, "Failed to log in, direct to the account dashboard, or receive return confirmation email: " + e.getMessage());
    }
}
...
public void initiateReturnRequest() {
    test = reports.createTest("Initiate Return Request: Submit a return request for an eligible product", 
    ...
    try {
        ...
        test.log(Status.PASS, "Return request is successfully submitted, and a confirmation message is displayed.");
    } catch (Exception e) {
...
public void checkReturnRequestConfirmationEmail() {
    test = reports.createTest("Check Return Request Confirmation Email: Verify receipt of confirmation email", 
    ...
    try {
        ...
        test.log(Status.FAIL, "Failed to receive return request confirmation email: " + e.getMessage());
    }
}
...
public void reviewReturnConfirmationEmailContent() {
    test = reports.createTest("Review Return Confirmation Email Content: Open and review the content of the email", 
    ...
    try {
        ...
        test.log(Status.FAIL, "Failed to open or review the return confirmation email content: " + e.getMessage());
    }
}
...
public void receiveConfirmationEmailForCancellations() {
    test = reports.createTest("Receive Confirmation Email for Cancellations: Log in to the customer account", 
    ...
    try {
        ...
        test.log(Status.PASS, "Successfully logged in to the customer account, and cancellation confirmation email is received.");
    } catch (Exception e) {
...
public void navigateToOrderHistory() {
    test = reports.createTest("Navigate to Order History: Access the order history section", 
    ...
    try {
        ...
        test.log(Status.PASS, "Order history section is accessible.");
    } catch (Exception e) {
...
public void cancelUnshippedOrder() {
    test = reports.createTest("Cancel Unshipped Order: Identify and cancel an order that has not yet been shipped", 
    ...
    try {
        ...
        test.log(Status.FAIL, "Failed to cancel the unshipped order: " + e.getMessage());
    }
}
